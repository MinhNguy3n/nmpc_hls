...
#
# nmpc_solver_v2_debug.tcl: Tcl script for re-creating project 'nmpc_solver_v2'
#
# Generated by Vivado on Tue Aug 18 20:12:50 EEST 2026
...
#
# 1. This project restoration tcl script (nmpc_solver_v2_debug.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/minh/Documents/UTU-Doctorate/nmpc_hls/hw/hdl/tcl_run/nmpc_solver_v2/nmpc_solver_v2.srcs/utils_1/imports/synth_1/design_npmc_solver_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/tcl_run/nmpc_solver_v2/nmpc_solver_v2.srcs/utils_1/imports/synth_1/design_npmc_solver_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../hls/vitis_ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "nmpc_solver_v2"
...
set script_file "nmpc_solver_v2_debug.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/tcl_run/nmpc_solver_v2"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../../../../tools/Xilinx/Vivado/2024.1/data/boards/board_files"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../hls/vitis_ip_repo"]" $obj
...
set_property -name "top" -value "design_nmpc_solver_wrapper" -objects $obj
...
set file "synth_1/design_npmc_solver_wrapper.dcp"
...
# Proc to create BD design_nmpc_solver
proc cr_bd_design_nmpc_solver { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name design_nmpc_solver
  ...
  tu-dresden_turun-yliopisto:hls:initializeParticles_set:1.0\
  tu-dresden_turun-yliopisto:hls:updateParticlesWithDuConstrains:1.0\
  tu-dresden_turun-yliopisto:hls:detectGlobalMinimum:1.0\
  tu-dresden_turun-yliopisto:hls:rand_wrapper:1.0\
...
proc create_hier_cell_nmpc_solver { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type intr pso_fsm_interrupt

  # Create instance: initializeParticles_0, and set properties
  set initializeParticles_0 [ create_bd_cell -type ip -vlnv tu-dresden_turun-yliopisto:hls:initializeParticles_set:1.0 initializeParticles_0 ]

  # Create instance: updateParticlesWithD_0, and set properties
  set updateParticlesWithD_0 [ create_bd_cell -type ip -vlnv tu-dresden_turun-yliopisto:hls:updateParticlesWithDuConstrains:1.0 updateParticlesWithD_0 ]

  # Create instance: detectGlobalMinimum_0, and set properties
  set detectGlobalMinimum_0 [ create_bd_cell -type ip -vlnv tu-dresden_turun-yliopisto:hls:detectGlobalMinimum:1.0 detectGlobalMinimum_0 ]

  # Create instance: rand_wrapper_0, and set properties
  set rand_wrapper_0 [ create_bd_cell -type ip -vlnv tu-dresden_turun-yliopisto:hls:rand_wrapper:1.0 rand_wrapper_0 ]
  ...
  # Create instance: pso_fsm_1, and set properties
  set pso_fsm_1 [ create_bd_cell -type ip -vlnv tu-dresden:hls:pso_fsm:1.0 pso_fsm_1 ]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins initializeParticles_0/p_rand_port]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins updateParticlesWithD_0/p_rand_port]
  ...
  connect_bd_intf_net -intf_net evaluateFitnessAndDe_1_m_axi_current_mem [get_bd_intf_pins evaluateFitnessAndDe_0/m_axi_current_mem] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net evaluateFitnessAndDe_1_m_axi_pso_mem [get_bd_intf_pins evaluateFitnessAndDe_0/m_axi_pso_mem] [get_bd_intf_pins smartconnect_2/S03_AXI]
  connect_bd_intf_net -intf_net evaluateFitnessAndDe_1_m_axi_x_mem [get_bd_intf_pins evaluateFitnessAndDe_0/m_axi_x_mem] [get_bd_intf_pins smartconnect_4/S02_AXI]
  connect_bd_intf_net -intf_net evaluateFitnessAndDe_1_m_axi_y_mem [get_bd_intf_pins evaluateFitnessAndDe_0/m_axi_y_mem] [get_bd_intf_pins smartconnect_3/S01_AXI]
  ...
  connect_bd_intf_net -intf_net pso_fsm_1_m_axi_constraints_mem [get_bd_intf_pins smartconnect_1/S01_AXI] [get_bd_intf_pins pso_fsm_1/m_axi_constraints_mem]
  connect_bd_intf_net -intf_net pso_fsm_1_m_axi_current_mem [get_bd_intf_pins smartconnect_0/S02_AXI] [get_bd_intf_pins pso_fsm_1/m_axi_current_mem]
  connect_bd_intf_net -intf_net pso_fsm_1_m_axi_nmpc_io [get_bd_intf_pins M00_AXI] [get_bd_intf_pins pso_fsm_1/m_axi_nmpc_io]
  connect_bd_intf_net -intf_net [get_bd_intf_nets pso_fsm_1_m_axi_nmpc_io] [get_bd_intf_pins M00_AXI] [get_bd_intf_pins ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net pso_fsm_1_m_axi_pso_mem [get_bd_intf_pins smartconnect_2/S01_AXI] [get_bd_intf_pins pso_fsm_1/m_axi_pso_mem]
  connect_bd_intf_net -intf_net rand_wrapper_0_rand_out [get_bd_intf_pins rand_wrapper_0/rand_out] [get_bd_intf_pins axis_broadcaster_0/S_AXIS]
  connect_bd_intf_net -intf_net s_axi_control_input_1 [get_bd_intf_pins s_axi_control_input] [get_bd_intf_pins pso_fsm_1/s_axi_control_r]
  connect_bd_intf_net -intf_net s_axi_control_pso_1 [get_bd_intf_pins s_axi_control_pso] [get_bd_intf_pins pso_fsm_1/s_axi_control]
  ...
  connect_bd_intf_net -intf_net updateParticlesWithD_0_m_axi_constraints_mem [get_bd_intf_pins updateParticlesWithD_0/m_axi_constraints_mem] [get_bd_intf_pins smartconnect_1/S02_AXI]
  ...
  connect_bd_intf_net -intf_net updateParticlesWithD_0_m_axi_pso_mem [get_bd_intf_pins updateParticlesWithD_0/m_axi_pso_mem] [get_bd_intf_pins smartconnect_2/S04_AXI]
  ...
  [get_bd_pins pso_fsm_1/ap_rst_n]
  connect_bd_net -net detectGlobalMinimum_0_ap_done  [get_bd_pins detectGlobalMinimum_0/ap_done] \
  [get_bd_pins pso_fsm_1/detect_min_ap_done]
  connect_bd_net -net evaluateFitnessAndDe_0_ap_done  [get_bd_pins evaluateFitnessAndDe_0/ap_done] \
  [get_bd_pins pso_fsm_1/eval_s_ap_done]
  connect_bd_net -net initializeParticles_0_ap_done  [get_bd_pins initializeParticles_0/ap_done] \
  [get_bd_pins pso_fsm_1/init_s_ap_done]
  ...
  [get_bd_pins pso_fsm_1/local_bestfitness]
  ...
  [get_bd_pins pso_fsm_1/local_du_max]
  ...
  [get_bd_pins pso_fsm_1/local_du_min]
  ...
  [get_bd_pins pso_fsm_1/local_u_max]
  ...
  [get_bd_pins pso_fsm_1/u_curr_local]
  ...
  [get_bd_pins pso_fsm_1/x_curr_local]
  ...
  [get_bd_pins pso_fsm_1/xref_local]
  connect_bd_net -net pso_fsm_1_detect_min_ap_start  [get_bd_pins pso_fsm_1/detect_min_ap_start] \
  [get_bd_pins detectGlobalMinimum_0/ap_start]
  connect_bd_net -net pso_fsm_1_eval_s_ap_start  [get_bd_pins pso_fsm_1/eval_s_ap_start] \
  [get_bd_pins evaluateFitnessAndDe_0/ap_start]
  connect_bd_net -net pso_fsm_1_init_s_ap_start  [get_bd_pins pso_fsm_1/init_s_ap_start] \
  [get_bd_pins initializeParticles_0/ap_start]
  connect_bd_net -net pso_fsm_1_interrupt  [get_bd_pins pso_fsm_1/interrupt] \
  [get_bd_pins pso_fsm_interrupt]
  connect_bd_net -net pso_fsm_1_k  [get_bd_pins pso_fsm_1/k] \
  [get_bd_pins detectGlobalMinimum_0/interaction]
  connect_bd_net -net pso_fsm_1_k_ap_vld  [get_bd_pins pso_fsm_1/k_ap_vld] \
  [get_bd_pins detectGlobalMinimum_0/interaction_ap_vld]
  connect_bd_net -net pso_fsm_1_rand_core_ap_start  [get_bd_pins pso_fsm_1/rand_core_ap_start] \
  [get_bd_pins rand_wrapper_0/ap_start]
  connect_bd_net -net pso_fsm_1_update_s_ap_start  [get_bd_pins pso_fsm_1/update_s_ap_start] \
  [get_bd_pins updateParticlesWithD_0/ap_start]
  connect_bd_net -net updateParticlesWithD_0_ap_done  [get_bd_pins updateParticlesWithD_0/ap_done] \
  [get_bd_pins pso_fsm_1/update_s_ap_done]
...
\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_0_M00_AXI [get_bd_intf_pins axi_smc_0/M00_AXI] [get_bd_intf_pins nmpc_solver/s_axi_control_input]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_1_M00_AXI] [get_bd_intf_pins axi_smc_1/M00_AXI] [get_bd_intf_pins ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net nmpc_solver_M00_AXI [get_bd_intf_pins nmpc_solver/M00_AXI] [get_bd_intf_pins axi_smc_1/S00_AXI]
  connect_bd_intf_net -intf_net s_axi_control_pso_1 [get_bd_intf_pins nmpc_solver/s_axi_control_pso] [get_bd_intf_pins axi_smc_0/M01_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins axi_smc_0/S00_AXI]

  # Create port connections
  connect_bd_net -net nmpc_solver_pso_fsm_interrupt  [get_bd_pins nmpc_solver/pso_fsm_interrupt] \
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs nmpc_solver/pso_fsm_1/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -with_name SEG_pso_fsm_1_Reg_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs nmpc_solver/pso_fsm_1/s_axi_control_r/Reg] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/initializeParticles_0/Data_m_axi_constraints_mem] [get_bd_addr_segs nmpc_solver/constraint_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/initializeParticles_0/Data_m_axi_current_mem] [get_bd_addr_segs nmpc_solver/current_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/initializeParticles_0/Data_m_axi_pso_mem] [get_bd_addr_segs nmpc_solver/pso_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/initializeParticles_0/Data_m_axi_v_mem] [get_bd_addr_segs nmpc_solver/v_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/initializeParticles_0/Data_m_axi_x_mem] [get_bd_addr_segs nmpc_solver/x_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/initializeParticles_0/Data_m_axi_y_mem] [get_bd_addr_segs nmpc_solver/y_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/updateParticlesWithD_0/Data_m_axi_constraints_mem] [get_bd_addr_segs nmpc_solver/constraint_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/updateParticlesWithD_0/Data_m_axi_current_mem] [get_bd_addr_segs nmpc_solver/current_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/updateParticlesWithD_0/Data_m_axi_pso_mem] [get_bd_addr_segs nmpc_solver/pso_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/updateParticlesWithD_0/Data_m_axi_v_mem] [get_bd_addr_segs nmpc_solver/v_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/updateParticlesWithD_0/Data_m_axi_x_mem] [get_bd_addr_segs nmpc_solver/x_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/updateParticlesWithD_0/Data_m_axi_y_mem] [get_bd_addr_segs nmpc_solver/y_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/detectGlobalMinimum_0/Data_m_axi_pso_mem] [get_bd_addr_segs nmpc_solver/pso_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/detectGlobalMinimum_0/Data_m_axi_y_mem] [get_bd_addr_segs nmpc_solver/y_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/evaluateFitnessAndDe_0/Data_m_axi_current_mem] [get_bd_addr_segs nmpc_solver/current_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/evaluateFitnessAndDe_0/Data_m_axi_pso_mem] [get_bd_addr_segs nmpc_solver/pso_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/evaluateFitnessAndDe_0/Data_m_axi_x_mem] [get_bd_addr_segs nmpc_solver/x_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/evaluateFitnessAndDe_0/Data_m_axi_y_mem] [get_bd_addr_segs nmpc_solver/y_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/pso_fsm_1/Data_m_axi_constraints_mem] [get_bd_addr_segs nmpc_solver/constraint_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/pso_fsm_1/Data_m_axi_current_mem] [get_bd_addr_segs nmpc_solver/current_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces nmpc_solver/pso_fsm_1/Data_m_axi_nmpc_io] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces nmpc_solver/pso_fsm_1/Data_m_axi_nmpc_io] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces nmpc_solver/pso_fsm_1/Data_m_axi_pso_mem] [get_bd_addr_segs nmpc_solver/pso_mem/axi_bram_ctrl_0/S_AXI/Mem0] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces nmpc_solver/pso_fsm_1/Data_m_axi_nmpc_io] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces nmpc_solver/pso_fsm_1/Data_m_axi_nmpc_io] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
...
# End of cr_bd_design_nmpc_solver()

cr_bd_design_nmpc_solver ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files design_nmpc_solver.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files design_nmpc_solver.bd ] 
set_property IS_ENABLED "1" [get_files design_nmpc_solver.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files design_nmpc_solver.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files design_nmpc_solver.bd ] 
set_property PFM_NAME "" [get_files design_nmpc_solver.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files design_nmpc_solver.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design_nmpc_solver.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files design_nmpc_solver.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files design_nmpc_solver.bd ] 
set_property USED_IN_SIMULATION "1" [get_files design_nmpc_solver.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files design_nmpc_solver.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list design_nmpc_solver.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/tcl_run/nmpc_solver_v2/nmpc_solver_v2.gen/sources_1/bd/design_nmpc_solver/hdl/design_nmpc_solver_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list design_nmpc_solver.bd]] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/design_npmc_solver_wrapper.dcp" -objects $obj
